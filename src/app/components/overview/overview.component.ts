...
export class OverviewComponent implements OnInit {
  ...
  setTitle() {
    ...
    this.title = this._titlePipe.transform(this.url);
  }

  getClients(pageNumber: number): void {
    this.data as IClientCore[];
    this._clientService.getClients(pageNumber).subscribe((clients) => {
      this.data = clients;
  ...
  getProjects(pageNumber: number): void {
    ...
    this._projectService.getProjects(pageNumber).subscribe((projects) => {
      this.data = projects;
  ...
  getTeamMembers(pageNumber: number): void {
    ...
    this._teamMemberService
      ...
      .subscribe((teamMembers) => (this.data = teamMembers));
  }
