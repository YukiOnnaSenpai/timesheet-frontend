...
export class TeamMemberService {
  ...
  dataChange: BehaviorSubject<ITeamMemberCore[]> = new BehaviorSubject<ITeamMemberCore[]>([]);
  httpOptions = {
  ...
  getTeamMembers(pageNumber:number) : Observable<ITeamMemberCore[]> {
    return this.httpClient.get<ITeamMemberCore[]>(this.BASE_URL + 'get-tms', { params: { page: pageNumber } })
  }

  getTeamMember(ITeamMemberId:number): Observable<ITeamMemberCore> {
    return this.httpClient.get<ITeamMemberCore>(this.BASE_URL + 'get-tm/' + ITeamMemberId).pipe(
  ...
  addTeamMember(ITeamMember: ITeamMember) : Observable<ITeamMember> {
    return this.httpClient.post<ITeamMember>(this.BASE_URL + 'create-tm', ITeamMember, this.httpOptions).pipe(
      tap((newITeamMember: ITeamMember) => console.log(newITeamMember)),
      catchError(this.handleError<ITeamMember>('add'))
    );
  }

  updateTeamMember(ITeamMember: ITeamMemberCore, ITeamMemberId: number): Observable<any> {
      return this.httpClient.put(this.BASE_URL + 'update-member/' + ITeamMemberId, ITeamMember, this.httpOptions).pipe(
  ...
  deleteTeamMember(ITeamMemberId: number): Observable<ITeamMember> {
    return this.httpClient.delete<ITeamMember>(this.BASE_URL + 'delete/' + ITeamMemberId, this.httpOptions).pipe(
